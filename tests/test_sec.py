        ...
        for doc in docs:
            if doc.period_end_date.year == 2017:
                if doc.xbrl and doc.form_type in ('10-K', '20-F'):
                    ...
                    assert doc.fields.currency('Revenues').code == company['currency']
                    print('==========')
                    ...
                    print('IncomeFromContinuingOperationsBeforeTax (EBIT?):', doc.fields['IncomeFromContinuingOperationsBeforeTax'])
                    print('ProfitLoss (Net Income):', doc.fields['NetIncomeLoss'])
                    print('Net Income attributable:', doc.fields['NetIncomeAttributableToParent'])
                    print('==========')
